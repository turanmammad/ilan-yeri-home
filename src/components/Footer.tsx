import { Apple, Play, Facebook, Instagram, Youtube, Send, MapPin, Phone, Mail, Shield, Clock, Award, ChevronRight } from "lucide-react";
import { Link } from "react-router-dom";

const Footer = () => (
  <footer className="border-t border-border bg-card" itemScope itemType="https://schema.org/Organization">
    {/* Stats band */}
    <div className="bg-primary/5 border-b border-border">
      <div className="container py-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
            <p className="text-2xl font-extrabold text-foreground">1M+</p>
            <p className="text-xs text-muted-foreground mt-1">Aktiv elan</p>
          </div>
          <div>
            <p className="text-2xl font-extrabold text-foreground">500K+</p>
            <p className="text-xs text-muted-foreground mt-1">İstifadəçi</p>
          </div>
          <div>
            <p className="text-2xl font-extrabold text-foreground">50+</p>
            <p className="text-xs text-muted-foreground mt-1">Şəhər</p>
          </div>
          <div>
            <p className="text-2xl font-extrabold text-foreground">24/7</p>
            <p className="text-xs text-muted-foreground mt-1">Dəstək xidməti</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="container py-12">
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
        ...
        <div className="col-span-2 md:col-span-3 lg:col-span-2">
          <Link to="/" className="flex items-center gap-2 mb-4" aria-label="UcuzTap ana səhifə">
            <div className="w-9 h-9 rounded-xl bg-primary flex items-center justify-center">
              <span className="font-extrabold text-primary-foreground text-base">U</span>
            </div>
            <span className="font-extrabold text-xl text-foreground" itemProp="name">UcuzTap</span>
          </Link>
        ...
        <nav aria-label="Populyar kateqoriyalar">
          <h4 className="font-bold text-foreground mb-4 text-sm">Populyar kateqoriyalar</h4>
        ...
        <nav aria-label="Şirkət haqqında">
          <h4 className="font-bold text-foreground mb-4 text-sm">Şirkət</h4>
          <ul className="space-y-2.5 text-sm text-muted-foreground">
        ...
        <nav aria-label="Dəstək">
          <h4 className="font-bold text-foreground mb-4 text-sm">Dəstək</h4>
          <ul className="space-y-2.5 text-sm text-muted-foreground">
        ...
        {/* Mobile app */}
        <div>
          <h4 className="font-bold text-foreground mb-4 text-sm">Mobil tətbiq</h4>
          <div className="space-y-2.5">
            <a href="#" className="flex items-center gap-3 bg-foreground text-card rounded-xl px-4 py-2.5 hover:bg-foreground/90 transition-colors" aria-label="App Store-dan yüklə">
              <Apple className="w-5 h-5 shrink-0" />
              <div className="text-left">
                <div className="text-[10px] text-card/60 leading-tight">App Store</div>
                <div className="text-xs font-semibold leading-tight">iOS üçün</div>
              </div>
            </a>
            <a href="#" className="flex items-center gap-3 bg-foreground text-card rounded-xl px-4 py-2.5 hover:bg-foreground/90 transition-colors" aria-label="Google Play-dən yüklə">
              <Play className="w-5 h-5 shrink-0" fill="currentColor" />
              <div className="text-left">
                <div className="text-[10px] text-card/60 leading-tight">Google Play</div>
                <div className="text-xs font-semibold leading-tight">Android üçün</div>
              </div>
            </a>
          </div>
    ...
    <div className="border-t border-border">
      <div className="container py-6">
        <h2 className="text-sm font-bold text-foreground mb-2">Azərbaycanda Pulsuz Elan Platforması — UcuzTap</h2>
        <p className="text-xs text-muted-foreground leading-relaxed max-w-4xl">
          ...
          Şəki və digər şəhərlərdə elan axtarın və ya pulsuz elan yerləşdirin. İkinci əl və yeni məhsulları ən sərfəli qiymətlərlə 
          alın və satın. Etibarlı satıcılar, təhlükəsiz alış-veriş və geniş kateqoriya seçimi ilə UcuzTap sizin üçün ən yaxşı seçimdir.
        </p>
      </div>
    </div>
    ...
    <div className="border-t border-border">
      <div className="container py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2.5" aria-label="Sosial media">
