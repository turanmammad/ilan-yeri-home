            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                ...
                <div className="flex gap-2 shrink-0">
                  <button className="h-10 px-4 bg-primary text-primary-foreground font-semibold rounded-xl text-sm hover:brightness-95 active:scale-95 transition-all flex items-center gap-2">
