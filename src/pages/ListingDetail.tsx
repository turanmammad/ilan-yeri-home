            ...
            <div className="bg-card rounded-2xl border border-border p-6 shadow-card">
              ...
              <div className="pt-4 border-t border-border space-y-3">
                <a
                  ...
                  className="w-full h-11 bg-[#25D366] text-white font-semibold rounded-xl text-sm hover:brightness-95 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
                >
