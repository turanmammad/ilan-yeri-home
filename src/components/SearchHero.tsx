      ...
      <div className="container relative z-40 text-center">
        ...
        >
          <div className={`flex items-center bg-card h-14 sm:h-16 rounded-2xl shadow-card transition-shadow ${focused ? 'shadow-card-hover ring-2 ring-primary' : ''}`}>
            ...
            <button className="h-10 sm:h-12 px-5 sm:px-7 bg-foreground text-card font-semibold rounded-xl mr-1.5 sm:mr-2 text-sm hover:bg-foreground/90 active:scale-95 transition-all flex items-center gap-2">
